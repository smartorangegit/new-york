      ...
      <div class="wrapper">
        ...
        <div data-wow-delay="0.5ms" class="contact_form wow bounceInLeft">
          <div class="form_name">
		   ...
		   <form id="cont" class="" action="../../application.php" method="post">
              <input type="text" name="name" value="" placeholder="Ваше имя">
              <input type="text" name="tel" value="" placeholder="Номер телефона" id="yourPhone" required onkeyup="javascript:mask('yourPhone', '(000)000-00-00', event);" value="(___)___-__-__">
