    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">5-комнатная квартира. Тип 5А.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/floor-21/KV-219-5a-3-1-2.jpg" alt="ЖК NEW YORK Concept House 5-комнатная квартира. Тип 5А.">
					</div>
