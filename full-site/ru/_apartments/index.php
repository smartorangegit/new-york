...
<html>
  <head>
    ...
    <link rel="alternate" hreflang="ua" href="<?php echo '/ua'.$_SERVER['REQUEST_URI'];?>" />
  ...
  <div class="section_vibor">
    ...
    <div class="section_name">Апартаменты</div>
    <div class="section_text">
      <p>Мы предлагаем разнообразие возможностей создать комфортное и стильное пространство для вашей жизни.</p>
      <p>Вы выбираете по своему вкусу и потребностям.</p>
      <p>Вместе мы создаем новое качество жизни – “NEW YORK concept house”.</p>
    </div>
    <h3>Выберите этаж:</h3>
    <ul>
    ...
    <div class="section_contact for_appart">
      <div class="wrapper">
        ...
        <div class="section_name">Узнать цену</div>
        <div data-wow-delay="0.5ms" class="contact_form wow bounceInLeft">
          ...
          <script src='https://www.google.com/recaptcha/api.js?hl=ua'></script>
              ...
              <textarea name="name" rows="8" cols="80" placeholder="Текст сообщения"></textarea>
