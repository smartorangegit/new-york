    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">1-комнатная квартира. Тип 1K.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/1K.jpg" alt="ЖК New York Concept House 1-комнатная квартира. Тип 1K.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площадь</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>16.37</td></tr>
							<tr><td>Прихожая</td><td>8.31</td></tr>
							<tr><td>Гостиная-спальня</td><td>15.15</td></tr>
							<!-- <tr><td>Спальня</td><td>Строка:4 Столбец:2</td></tr> -->
							<tr><td>Санузел</td><td>6.21</td></tr>
							<!-- <tr><td>Туалет</td><td>Строка:6 Столбец:2</td></tr> -->
							<tr><td>Лоджия</td><td>4.63</td></tr>
							<tr><td>Жилая</td><td>15.15</td></tr>
							<tr><td>Общая</td><td>50.67</td></tr>
