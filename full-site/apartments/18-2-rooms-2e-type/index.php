    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">2-кімнатна квартира. Тип 2E.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/2E.jpg" alt="ЖК NEW YORK Concept House 2-кімнатна квартира. Тип 2E.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>13.55</td></tr>
							<tr><td>Передпокій</td><td>18.8</td></tr>
							<tr><td>Вітальня</td><td>28.47</td></tr>
							<tr><td>Спальня</td><td>16.19</td></tr>
							<tr><td>Санвузол</td><td>4.21</td></tr>
							<tr><td>Туалет</td><td>2.13</td></tr>
							<tr><td>Лоджія</td><td>3.73</td></tr>
							<tr><td>Житлова</td><td>44.63</td></tr>
							<tr><td>Загальна</td><td>87.03</td></tr>
				...
				<div class="appart_btns clearfix">
					...
					<div class="btns_right">
						<a target="_blank" class="appbut hvr-shutter-out-vertical" dounload href="/img/Kv/pdf/2E.pdf">завантажити PDF</a>
