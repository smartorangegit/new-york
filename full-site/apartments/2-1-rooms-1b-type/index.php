    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">1-кімнатна квартира. Тип 1Б.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/1B.jpg" alt="ЖК NEW YORK Concept House 1-кімнатна квартира. Тип 1Б.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>12.11</td></tr>
							<tr><td>Передпокій</td><td>9.72</td></tr>
							<tr><td>Вітальня-спальня</td><td>15.8</td></tr>
							<!-- <tr><td>Спальня</td><td>Строка:4 Столбец:2</td></tr> -->
							<tr><td>Санвузол</td><td>5.21</td></tr>
							<tr><td>Лоджія</td><td>3.13</td></tr>
              <tr><td>Гардероб</td><td>3.38</td></tr>
							<tr><td>Житлова</td><td>15.8</td></tr>
							<tr><td>Загальна</td><td>49.22</td></tr>
				...
				<div class="appart_btns clearfix">
					...
					<div class="btns_right">
						<a class="appbut hvr-shutter-out-vertical" dounload href="/img/Kv/pdf/1B.pdf">завантажити PDF</a>
