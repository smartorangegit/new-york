    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">1-кімнатна квартира. Тип 1А.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/1A.jpg" alt="ЖК NEW YORK Concept House 1-кімнатна квартира. Тип 1А.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>13,92</td></tr>
							<tr><td>Передпокій</td><td>14,65</td></tr>
							<tr><td>Вітальня-спальня</td><td>18,87</td></tr>
							<!-- <tr><td>Спальня</td><td>Строка:4 Столбец:2</td></tr> -->
							<tr><td>Санвузол</td><td>6,83</td></tr>
							<!-- <tr><td>Туалет</td><td>Строка:6 Столбец:2</td></tr> -->
							<tr><td>Лоджія</td><td>3,61</td></tr>
							<tr><td>Житлова</td><td>18,87</td></tr>
							<tr><td>Загальна</td><td>57,43</td></tr>
				...
				<div class="appart_btns clearfix">
					...
					<div class="btns_right">
						<a target="_blank" class="appbut hvr-shutter-out-vertical" dounload href="/img/Kv/pdf/1A.pdf">завантажити PDF</a>
