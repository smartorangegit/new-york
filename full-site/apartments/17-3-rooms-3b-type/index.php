    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">3-кімнатна квартира. Тип 3Б.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/3B.jpg" alt="ЖК NEW YORK Concept House 3-кімнатна квартира. Тип 3Б.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>14.89</td></tr>
							<tr><td>Передпокій</td><td>19.38</td></tr>
							<tr><td>Вітальня</td><td>14.9</td></tr>
							<tr><td>Спальня 1</td><td>16.37</td></tr>
              <tr><td>Спальня 2</td><td>13.59</td></tr>
							<tr><td>Санвузол</td><td>5.3</td></tr>
							<tr><td>Туалет</td><td>2.94</td></tr>
							<tr><td>Лоджія</td><td>3.67</td></tr>
							<tr><td>Житлова</td><td>44.86</td></tr>
							<tr><td>Загальна</td><td>91.06</td></tr>
				...
				<div class="appart_btns clearfix">
					...
					<div class="btns_right">
						<a target="_blank" class="appbut hvr-shutter-out-vertical" dounload href="/img/Kv/pdf/3B.pdf">завантажити PDF</a>
