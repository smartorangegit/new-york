			...
			<div class="wrapper">
				...
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/2V.jpg" alt="ЖК NEW YORK Concept House 2-кімнатна квартира. Тип 2В.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>9.98</td></tr>
							<tr><td>Передпокій</td><td>13.2</td></tr>
							<tr><td>Вітальня</td><td>18.3</td></tr>
							<tr><td>Спальня</td><td>13.21</td></tr>
							<tr><td>Санвузол</td><td>5.36</td></tr>
							<tr><td>Туалет</td><td>3.06</td></tr>
							<!-- <tr><td>Лоджія</td><td>5.62</td></tr> -->
							<tr><td>Житлова</td><td>31.51</td></tr>
							<tr><td>Загальна</td><td>63.11</td></tr>
				...
				<div class="appart_btns clearfix">
					...
					<div class="btns_right">
						<a target="_blank" class="appbut hvr-shutter-out-vertical" dounload href="/img/Kv/pdf/2V.pdf">завантажити PDF</a>
