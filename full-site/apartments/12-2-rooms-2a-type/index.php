			...
			<div class="wrapper">
				...
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/2A.jpg" alt="ЖК NEW YORK Concept House 2-кімнатна квартира. Тип 2А.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>11.4</td></tr>
							<tr><td>Передпокій</td><td>11.37</td></tr>
							<tr><td>Вітальня</td><td>14.85</td></tr>
							<tr><td>Спальня</td><td>14.96</td></tr>
							<tr><td>Санвузол</td><td>3.87</td></tr>
							<tr><td>Туалет</td><td>1.9</td></tr>
							<tr><td>Лоджія</td><td>3,57</td></tr>
							<tr><td>Житлова</td><td>29.81</td></tr>
							<tr><td>Загальна</td><td>61.21</td></tr>
				...
				<div class="appart_btns clearfix">
					...
					<div class="btns_right">
						<a target="_blank" class="appbut hvr-shutter-out-vertical" dounload href="/img/Kv/pdf/2A.pdf">завантажити PDF</a>
