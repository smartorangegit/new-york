    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">2-кімнатна квартира. Тип 2Б.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/2B.jpg" alt="ЖК NEW YORK Concept House 2-кімнатна квартира. Тип 2Б.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>13.06</td></tr>
							<tr><td>Передпокій</td><td>8.98</td></tr>
							<tr><td>Вітальня</td><td>15.56</td></tr>
							<tr><td>Спальня</td><td>19.77</td></tr>
							<tr><td>Санвузол</td><td>4.12</td></tr>
							<tr><td>Туалет</td><td>2.35</td></tr>
							<tr><td>Лоджія</td><td>5.62</td></tr>
							<tr><td>Житлова</td><td>35.33</td></tr>
							<tr><td>Загальна</td><td>67.66</td></tr>
				...
				<div class="appart_btns clearfix">
					...
					<div class="btns_right">
						<a target="_blank" class="appbut hvr-shutter-out-vertical" dounload href="/img/Kv/pdf/2B.pdf">завантажити PDF</a>
