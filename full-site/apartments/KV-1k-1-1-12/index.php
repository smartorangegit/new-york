    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">1-кімнатна квартира. Тип 1К.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/floor-17-20/KV-1k-1-1-12.jpg" alt="ЖК NEW YORK Concept House 1-кімнатна квартира. Тип 1К.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Передпокій</td><td>3,04</td></tr>
							<tr><td>Кухня-їдальня</td><td>29,34</td></tr>
							<tr><td>Вітальня 1</td><td>11,08</td></tr>
							<tr><td>Ванна кімната 1</td><td>4,72</td></tr>
              <tr><td>Гардеробна 1</td><td>2,86</td></tr>
							
							<tr><td>Комора</td><td>1,4</td></tr>
							<tr><td>Загальна</td><td>52,44</td></tr>
