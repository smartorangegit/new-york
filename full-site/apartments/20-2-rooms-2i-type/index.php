    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">2-кімнатна квартира. Тип 2И.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/2I.jpg" alt="ЖК NEW YORK Concept House 2-кімнатна квартира. Тип 2И.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>13,16</td></tr>
							<tr><td>Передпокій</td><td>12.43</td></tr>
							<tr><td>Вітальня</td><td>24.14</td></tr>
							<tr><td>Спальня</td><td>17.05</td></tr>
							<tr><td>Санвузол</td><td>4.41</td></tr>
							<tr><td>Туалет</td><td>1.92</td></tr>
							<tr><td>Лоджія</td><td>4.06</td></tr>
							<tr><td>Житлова</td><td>44.16</td></tr>
							<tr><td>Загальна</td><td>80.32</td></tr>
				...
				<div class="appart_btns clearfix">
					...
					<div class="btns_right">
						<a target="_blank" class="appbut hvr-shutter-out-vertical" dounload href="/img/Kv/pdf/2I.pdf">завантажити PDF</a>
