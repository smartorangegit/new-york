...
<html>
  ...
  <div class="section_vibor">
    <div class="wrapper">
      <div class="section_name">Квартири у ЖК New York Concept House</div>
        <div class="section_text">
          <p>
            Ми пропонуємо різні планування 1-, 2- і 3-кімнатні квартири. Ви можете самостійно створити будь-який дизайн та планування квартири, в якій вам буде комфортно жити. Завдяки
            монолітно-каркасної технології, ви можете створити власний дизайн, виходячи з потреб вашої родини.
          </p>
        </div>
        <h3>Оберіть поверх:</h3>
          <ul>
            ...
            <li><a id="callback2" onclick="setfloorpick(35)" class="appbut hvr-shutter-out-vertical" href="#" style="text-transform:uppercase">Узнать цену</a></li>
          </ul>
        ...
        <div class="section_text">
          ...
          <p>
            ...
            ЖК New York Concept House &minus; це 231 квартира на 21 поверсі. Велика частина квартир &minus; одно і двокімнатні, але є і трикімнатні апартаменти, а також пентхаус на останньому поверсі. На
    ...
    <div id="kimnata" class="section_kimnatna">
      <div class="one_slider">
        <ul class="bxslider">
            <li>
              <p class="section_name">1-кімнатна квартира</p>
              <p class="section_text">
                ...
                Головною перевагою наших квартир є можливість самостійного перепланування приміщення за вашим бажанням. Так, завдяки монолітно-каркасної технології будівництва ви самі
                ...
                присутній простора вітальня з балконом або лоджією. У найбільших однокімнатних квартир (56 м2) передбачена також комора.
              </p>
            </li>
            <li>
              <p class="section_name">2-кімнатна квартира</p>
              <p class="section_text">
            ...
            <li>
              <p class="section_name">3-кімнатна квартира</p>
              <p class="section_text">
    ...
    <div class="section_contact for_appart">
      <div class="wrapper">
        ...
        <div class="section_name">Дізнатись ціну</div>
        <div data-wow-delay="0.5ms" class="contact_form wow bounceInLeft">
          ...
          <script src='https://www.google.com/recaptcha/api.js?hl=ua'></script>
              ...
              <input type="name" name="" value="" placeholder="Ваше і&prime;мя">
              <input type="tel" name="" value="" placeholder="Номер телефону">
              <textarea name="name" rows="8" cols="80" placeholder="Текст повідомлення"></textarea>
              <div class="g-recaptcha" data-theme="light" data-sitekey="6Le01hgUAAAAAEt62DDW0IVpp1uU5tEC7eeaXl5T" style="overflow: hidden;"></div>
