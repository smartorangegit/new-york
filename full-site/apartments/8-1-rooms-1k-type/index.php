    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">1-кімнатна квартира. Тип 1K.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/1K.jpg" alt="ЖК NEW YORK Concept House 1-кімнатна квартира. Тип 1K.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>16.37</td></tr>
							<tr><td>Передпокій</td><td>8.31</td></tr>
							<tr><td>Вітальня-спальня</td><td>15.15</td></tr>
							<!-- <tr><td>Спальня</td><td>Строка:4 Столбец:2</td></tr> -->
							<tr><td>Санвузол</td><td>6.21</td></tr>
							<!-- <tr><td>Туалет</td><td>Строка:6 Столбец:2</td></tr> -->
							<tr><td>Лоджія</td><td>4.63</td></tr>
							<tr><td>Житлова</td><td>15.15</td></tr>
							<tr><td>Загальна</td><td>50.67</td></tr>
