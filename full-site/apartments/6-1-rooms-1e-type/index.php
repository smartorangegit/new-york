    ...
    <div class="section_appart">
			...
			<div class="wrapper">
				<div class="appart_name clearfix">
					...
					<div class="section_name">1-кімнатна квартира. Тип 1E.</div>
				</div>
				<div class="appart_block clearfix">
					<div class="appart_plan wow fadeInDown">
						<img src="/img/Kv/3d/1E.jpg" alt="ЖК NEW YORK Concept House 1-кімнатна квартира. Тип 1E.">
					</div>
					<div class="appart_info wow fadeInDown">
						<table>
							<tr><th>Площа</th><th>м<sup>2</sup></th></tr>
							<tr><td>Кухня</td><td>12.74</td></tr>
							<tr><td>Передпокій</td><td>11.44</td></tr>
							<tr><td>Вітальня-спальня</td><td>20.16</td></tr>
							<!-- <tr><td>Спальня</td><td>Строка:4 Столбец:2</td></tr> -->
							<tr><td>Санвузол</td><td>5.27</td></tr>
							<!-- <tr><td>Туалет</td><td>Строка:6 Столбец:2</td></tr> -->
							<tr><td>Лоджія</td><td>4.16</td></tr>
              <tr><td>Кладовая</td><td>2</td></tr>
							<tr><td>Житлова</td><td>20.16</td></tr>
							<tr><td>Загальна</td><td>55.77</td></tr>
							<tr><td>Поверх</td><td>3 - 21</td></tr>
						</table>
					</div>
				</div>
				<div class="appart_btns clearfix">
					...
					<div class="btns_right">
						<a target="_blank" class="appbut hvr-shutter-out-vertical" dounload href="/img/Kv/pdf/1E.pdf">завантажити PDF</a>
