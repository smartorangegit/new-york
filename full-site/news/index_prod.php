...
<html>
  <head>
    <meta charset="utf-8">
    <title>≡ ЖК Нью Йорк 》 Новости житлового комплексу NEW YORK Concept House</title>
    ...
    <meta name="description" content="【Новини】 NEW YORK Concept House — це Американське якість за українську ціну в центрі! ✅【NEW YORK】 7 хвилин пішки до найближчих 2-х станцій метро, ​​20 хвилин до Хрещатика  ✅【NEW YORK】 Затишний сад у дворі, два дитячих та один баскетбольний майданчики! .... ✅【NEW YORK】 - це частинка Манхеттена в українській столиці!">
...
while ($myrow = mysqli_fetch_array($sel)){
    ...
    <li class="news_item">
        ...
        <!-- <img <?LazyLoad($myrow['img_path']."/".$myrow['img_name']);?>  alt="7 идей для интерьера"> -->
