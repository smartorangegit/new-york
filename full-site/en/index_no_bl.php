...
<html>
  ...
  <body wow fadeIn>
    ...
    <div class="section_one">
      <div class="wrapper">
        <div class="one_logo">
          <img src="/img/logoNewYork.svg" alt="Логотип ЖК New York Concept House">
        ...
        <div class="wrapper">
          ...
          <div id="genplan" class="four_interactive clearfix">
            ...
            <div class="four_interactive_main wow bounceInLeft" data-wow-delay="0.5ms">
              <img class="b-lazy" src=data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==  data-src="/img/blag/blag-text.jpg" alt="ЖК Нью-Йорк Concept House генплан благоустройства территории"/>
    ...
    <div class="section_five">
      <div class="parallax-container">
        <div class="section_name">
          ...
          <a href="/ru/panorama/"><img src="/img/360.png" alt="panorama"></a>
        </div>
    ...
    <div class="section_six">
      <div class="six_info">
        ...
        <div class="parallax"><img src="/img/plan.jpg" alt="plan"></div>
      </div>
    </div>
    <!-- ========== end section six=============== -->
    ...
    <div class="section_seven">
      <div class="wrapper">
        ...
        <div class="developer_logo clearfix">
          <img src="/img/logoriww.svg" alt="riverside">
          <img src="/img/logoKDD.svg" alt="KDD">
        </div>
        ...
        <div class="document clearfix">
          ...
          <div class="document_item wow fadeIn">
            <a href="/img/docs/expert1.jpg" data-fancybox="group2" data-caption="Заключение экспертизы">
    ...
    <div class="section_gallery">
      ...
      <div class="slider1">
        <a class="slide" data-fancybox="group4" href="/img/gal/1b.jpg"><img src="/img/gal/1.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/2b.jpg"><img src="/img/gal/2.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/3b.jpg"><img src="/img/gal/3.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/4b.jpg"><img src="/img/gal/4.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/5b.jpg"><img src="/img/gal/5.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/6b.jpg"><img src="/img/gal/6.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/7b.jpg"><img src="/img/gal/7.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/8b.jpg"><img src="/img/gal/8.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/9b.jpg"><img src="/img/gal/9.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/10b.jpg"><img src="/img/gal/10.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/11b.jpg"><img src="/img/gal/11.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/12b.jpg"><img src="/img/gal/12.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/13b.jpg"><img src="/img/gal/13.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/14b.jpg"><img src="/img/gal/14.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/15b.jpg"><img src="/img/gal/15.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/16b.jpg"><img src="/img/gal/16.jpg"></a>
        <a class="slide" data-fancybox="group4" href="/img/gal/17b.jpg"><img src="/img/gal/17.jpg"></a>
		<a class="slide" data-fancybox="group4" href="/img/gal/18b.jpg"><img src="/img/gal/18.jpeg"></a>
		<a class="slide" data-fancybox="group4" href="/img/gal/19b.jpg"><img src="/img/gal/19.jpeg"></a>
		<a class="slide" data-fancybox="group4" href="/img/gal/20b.jpg"><img src="/img/gal/20.jpeg"></a>
		<a class="slide" data-fancybox="group4" href="/img/gal/21b.jpg"><img src="/img/gal/21.jpeg"></a>
		<a class="slide" data-fancybox="group4" href="/img/gal/22b.jpg"><img src="/img/gal/22.jpeg"></a>
		<a class="slide" data-fancybox="group4" href="/img/gal/23b.jpg"><img src="/img/gal/23.jpeg"></a>
		<a class="slide" data-fancybox="group4" href="/img/gal/24b.jpg"><img src="/img/gal/24.jpeg"></a>
      </div>
    </div>
    <!-- ========== end section gallery=============== -->
      ...
      <div class="wrapper">
        ...
        <div data-wow-delay="0.5ms" class="contact_form wow bounceInLeft">
          ...
          <script src='https://www.google.com/recaptcha/api.js?hl=ua'></script>
			...
			<form class="" action="<?php  $_SERVER['DOCUMENT_ROOT'] ?>/application.php" method="post">
              <input type="text" name="name" value="" placeholder="Ваше имя">
              <input type="text" name="tel" value="" placeholder="Номер телефона">
              <textarea  rows="8" cols="80" placeholder="Текст сообщения"></textarea>
    ...
    <div class="main_overlay">
      <div class="main_modal">
        <div class="modal_content">
          ...
          <!-- <h3>ПОКУПАЙТЕ КВАРТИРУ В ИЮНЕ!</h3> -->
  ...
  <!-- ======<end modal>======== -->
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC_XaLtOX8vgeRAIeqgdfHh9q1lNTIS3Y0&callback=initMap&language=ru&region=RU"></script>
