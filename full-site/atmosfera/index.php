...
<html>
  <head>
    <meta charset="utf-8">
    <title>ЖК NEW YORK Concept House - SFERA Living System</title>
    ...
    <meta name="description" content="ЖК NEW YORK Concept House лучшие традиции американской архитектуры. Отдел продаж: ☎ 044 290 33 90, Адрес г.Киев, ул.Антоновича 74">
  ...
  <body>
    ...
    <div class="content content_atmosfera">
      <div class="content_wrap clearfix">
        <h1 class="section_name">ATMOSFERA</h1>
        <div class="trigger-0"></div>
        <div class="atmo__top">
          <div class="content_subname section_text">це високотехнологічна управляюча компанія, яка піклується про комфортне та щасливе життя мешканців в усіх будинках, створених компанією SAGA Development.</div>
        </div>
        <div class="atmo__top">
          ...
          <div class="atmo__img">
            ...
            <div class="content_text section_text">
              <p>
        ...
        <div class="atm__box">
          ...
          <div class="atm__content">
            ...
            <ul class="atm__lost section_text" >
        ...
        <div class="atm__box">
          ...
          <div class="atm__content">
            <div class="content_subname">УПРАВЛЯЮЧА КОМПАНІЯ ATMOSFERA</div>
        ...
        <div class="atm__box">
          ...
          <div class="atm__content">
            <div class="content_subname">МОБІЛЬНИЙ ДОТАТОК SFERA</div>
            <ul class="section_text">
        ...
        <div class="atm__box">
          ...
          <div class="atm__content">
            <div class="content_subname">ЧАТ SFERA</div>
            <ul class="section_text">
        ...
        <div class="atm__box">
          ...
          <div class="atm__content">
            <div class="content_subname">СИСТЕМА «РОЗУМНИЙ ДІМ»</div>
            <ul class="section_text">
        ...
        <div class="atm__box">
          ...
          <div class="atm__content">
            <div class="content_subname">СИСТЕМА «РОЗУМНА КВАРТИРА»</div>
            <div class="content_text section_text">
              <p>
      ...
      .content_atmosfera .section_text{
        text-indent: 0;
      }
